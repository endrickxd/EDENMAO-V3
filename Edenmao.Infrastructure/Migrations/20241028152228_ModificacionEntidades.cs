    ...
    public partial class ModificacionEntidades : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Personificaciones", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "Articulos_Personificaciones",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Articulos_Personificaciones", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Articulos_Personificaciones_Articulos_IdArticulo",
                        column: x => x.IdArticulo,
                        principalTable: "Articulos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Articulos_Personificaciones_Personificaciones_IdPersonificacion",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetallePedidos_Articulos_IdArticulo",
                        column: x => x.IdArticulo,
                        principalTable: "Articulos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "DetallePedidos_Personificaciones",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetallePedidos_Personificaciones", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetallePedidos_Personificaciones_DetallePedidos_IdDetallePedido",
                        column: x => x.IdDetallePedido,
                        principalTable: "DetallePedidos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetallePedidos_Personificaciones_Personificaciones_IdPersonificacion",
                        column: x => x.IdPersonificacion,
                        principalTable: "Personificaciones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Articulos_Personificaciones_IdArticulo",
                table: "Articulos_Personificaciones",
                column: "IdArticulo");

            migrationBuilder.CreateIndex(
                name: "IX_Articulos_Personificaciones_IdPersonificacion",
                table: "Articulos_Personificaciones",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallePedidos_IdArticulo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallePedidos_Personificaciones_IdDetallePedido",
                table: "DetallePedidos_Personificaciones",
                column: "IdDetallePedido");

            migrationBuilder.CreateIndex(
                name: "IX_DetallePedidos_Personificaciones_IdPersonificacion",
                table: "DetallePedidos_Personificaciones",
                column: "IdPersonificacion");
